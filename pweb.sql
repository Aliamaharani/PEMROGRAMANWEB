...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2026 at 11:18 AM
...
INSERT INTO `orders` (`id`, `customer_name`, `total`, `payment_method`, `created_at`) VALUES
(1, NULL, 275000, NULL, '2026-01-29 12:15:24'),
(2, NULL, 275000, NULL, '2026-01-29 12:19:17'),
(3, NULL, 230000, NULL, '2026-01-29 12:22:11'),
(4, NULL, 195000, NULL, '2026-01-29 12:24:54'),
(5, NULL, 275000, NULL, '2026-01-29 14:48:34'),
(6, NULL, 275000, NULL, '2026-01-29 15:42:15'),
(7, NULL, 230000, NULL, '2026-01-29 15:42:45');
...
(1, 1, 'Aesthetic Cardigan', 275000, 1, 275000),
(2, 2, 'Aesthetic Cardigan', 275000, 1, 275000),
(3, 3, 'Soft Pastel Skirt', 230000, 1, 230000),
(4, 4, 'Velvet Rose Blouse', 195000, 1, 195000),
(5, 5, 'Aesthetic Cardigan', 275000, 1, 275000),
(6, 6, 'Aesthetic Cardigan', 275000, 1, 275000),
(7, 7, 'Soft Pastel Skirt', 230000, 1, 230000);
...
(9, 'Aesthetic Cardigan', 275000, 'Cardigan warna lembut', 'aesthetic_cardigan.jpeg', '2026-01-29 04:00:04'),
(10, 'Soft Pastel Skirt', 230000, 'Rok pastel aesthetic', 'soft_pastel_skirt.jpeg', '2026-01-29 04:00:04'),
(11, 'Velvet Rose Blouse', 195000, 'Blouse velvet elegan', 'velvet_rose_blouse.jpeg', '2026-01-29 04:00:04'),
(12, 'Vintage Ribbon Dress', 320000, 'Dress vintage dengan pita', 'vintage_ribbon_dress.jpeg', '2026-01-29 04:00:04');
...
CREATE TABLE `tbl_datapengiriman` (
  ...
  `catatan_kirim` text CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
(1, 'zulpa', 'JupeAbadi@gmail.com', '$2y$10$7IxGDzZSmbENGiUTxzmHuOpmLkzDnT1HzuRmMLI3hZJYxC1gFYDOu'),
(2, 'annnsnr', 'annisanurullaili2@gmail.com', '$2y$10$k4YfxtI9IJU1CWhWUOK4IeEXbry1pkOO5u.OxpYaZmXfliHyHF66C'),
(3, 'annnsnr', 'annisanurullaili2@gmail.com', '$2y$10$ZQukWOYVzI8Ix6LUr.WpdOc9ffBY1uABEI6PfAdSrKGE1ZLOEfs1K'),
(4, 'aziz', 'Aziz@gmail.com', '$2y$10$y1GS9WszV98outcyHJOwhu4s3uOQA3RlDkGOnyldv/VBtdQqYGYki'),
(5, 'alia', 'alia@gmail.com', '$2y$10$9XIhXnYR24HBoFdtE8dxleDlK2NRXdpi0FhQhQyXBvRlX.vxt9H4a'),
(6, 'pelanggan', 'pelanggan@gmail.com', '$2y$10$8.QQ7IaRd008a1DVXCz/yuTqYpaEm8Y/zYTEkqr2dZgU8YUB1ZBJS'),
(7, 'zira', 'zira@gmail.com', '$2y$10$nLTvJpVtHw2Pe0emnSJL1.y8VXGGfyMCWZBHM3FzgEDdTmn06Y1vW'),
(8, 'syifa', 'syifa@gmail.com', '$2y$10$tgxjEkp53QQZOqWRQyQoK.SOssHgsPk5JYLCzS83RwHF0idgIz9/e'),
(9, 'rose', 'rose@gmail.com', '$2y$10$lq9asimp4EWAp0fUy5H16e2nEsVQju4Pm.EbIQWG25tey72tMDBFe'),
(10, 'nusput', 'nusput@gmail.com', '$2y$10$vpVv6b5vF0zwfh.7BAWEPObMzpbzSbEcE1WXYwSmsOg61hT52eeci');
